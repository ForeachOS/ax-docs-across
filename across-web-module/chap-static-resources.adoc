...
With the default settings static resources will be configured with link:index.adoc#resource-url-versioning[versioned urls] and link:index.adoc#client-side-caching[client-side caching].
