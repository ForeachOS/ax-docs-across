...
In addition to default context configuration options, it also adds selected <<spring-boot-autoconfigure,Spring Boot autoconfiguration classes>> and enables link:index.adoc#dynamic-across-modules[dynamic modules].
