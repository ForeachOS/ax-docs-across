...
[#installers]
=== Installers
At several points during bootstrap of an Across context, link:../developing-modules/index.adoc#installer-bootstrap-phases[installers can get executed].

[#bootstrap-events]
=== Bootstrap events
During bootstrap, the Across context link:index.adoc#dev-appl-bootstrap-events[publishes several events] that allow other components to act upon.
