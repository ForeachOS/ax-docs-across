...
|Utility bean that can be used to verify if   [development-mode](../developing-applications/index.adoc#development-mode) <<development-mode,development mode>> is active, and to get development locations for resources files.
