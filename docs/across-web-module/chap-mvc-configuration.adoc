...
* link:index.adoc#static-resources[static resource resolving and versioning]
* support for link:index.adoc#request-mapping-extensions[custom request conditions and prefixed request mappings]
