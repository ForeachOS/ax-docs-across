...
= Developing Across applications
:toc: left
:toc-title: Developing Across applications
:toclevels: 2
:sectnums:
:chapter-number: 0
:docinfo1:
...
include::developing-applications/chap-configuring-across-context.adoc[]

include::developing-applications/chap-application.adoc[]
...
include::developing-applications/chap-across-bootstrap.adoc[]

include::developing-applications/chap-across-properties.adoc[]

include::developing-applications/chap-across-datasource.adoc[]

include::developing-applications/chap-across-events.adoc[]

include::developing-applications/chap-across-refreshing.adoc[]

include::developing-applications/chap-across-ordering-beans.adoc[]
...
include::developing-applications/chap-across-development-mode.adoc[]
