...
* Spring Platform Brussels-SR13
* Spring Framework 4.3.19
* Spring Boot 1.5.16

=== Across Web
* `ViewElementBuilder` improvements
...
** chaining `ViewElementPostProcessors` on any builder is now possible using `andThen()` which will return a new builder instance
