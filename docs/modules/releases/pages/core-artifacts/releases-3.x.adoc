...
* link:https://across-docs.foreach.be/across/3.1.2-SNAPSHOT/javadoc/[Deprecated HikariDataSourceHelper] in favour of DataSourceBuilder or Spring Boot datasource properties.
