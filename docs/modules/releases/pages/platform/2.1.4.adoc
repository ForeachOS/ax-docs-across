...
:across-platform-version: 2.1.4.RELEASE
...
:asm-admin-web-module-version: 3.1.1.RELEASE
...
:asm-entity-module-version: 3.3.0.RELEASE
...
|AdminWebModule
|3.1.0.RELEASE
|xref:admin-web-module::releases/3.x.adoc#3-1-1[3.1.1.RELEASE]

|BootstrapUiModule
|2.1.1.RELEASE
|xref:bootstrap-ui-module::releases/2.x.adoc#2-2-1[2.2.1.RELEASE]

|DynamicFormsModule
|0.0.2.RELEASE
|xref:dynamic-forms-module::releases/0.0.x.adoc#0-0-3[0.0.3.RELEASE]

|EntityModule
|3.2.0.RELEASE
|xref:entity-module::releases/3.x.adoc#3-3-0[3.3.0.RELEASE]

|FileManagerModule
|1.3.0.RELEASE
|xref:file-manager-module::releases/1.x.adoc#1-4-0[1.4.0.RELEASE]

|OAuth2Module
|2.1.0.RELEASE
|xref:oauth2-module::releases/2.x.adoc#2-1-1[2.1.1.RELEASE]

|SpringBatchModule
|1.0.1.RELEASE
|xref:spring-batch-module::releases/1.x.adoc#1-0-2[1.0.2.RELEASE]

|SpringSecurityAclModule
|3.0.1.RELEASE
|xref:spring-security-acl-module::releases/3.x.adoc#3-0-2[3.0.2.RELEASE]

|UserModule
|3.1.0.RELEASE
|xref:user-module::releases/3.x.adoc#3-1-1[3.1.1.RELEASE]

|WebCmsModule
|0.0.6.RELEASE
|xref:web-cms-module::releases/0.0.x.adoc#0-0-7[0.0.7.RELEASE]

|ImageServer
|4.0.0.RELEASE
|{ais-image-server-url}[5.0.0.RELEASE]
