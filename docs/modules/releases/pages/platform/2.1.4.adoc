...
:spring-platform-version: Brussels-SR16
:spring-platform-url: https://docs.spring.io/platform/docs/Brussels-SR16/reference/htmlsingle/#appendix-dependency-versions
:across-version: 3.2.0-SNAPSHOT
...
:asm-file-manager-module-version: 1.3.1-SNAPSHOT
...
|Across
|3.1.2.RELEASE
|xref:core-artifacts/releases-3.x.adoc#3-2-0[3.2.0-SNAPSHOT]
...
|FileManagerModule
|1.3.0.RELEASE
|xref:file-manager-module::releases/1.x.adoc#1-3-1[1.3.1-SNAPSHOT]
...
|Spring Platform
|Brussels-SR15
|https://docs.spring.io/platform/docs/Brussels-SR16/reference/htmlsingle[Brussels-SR16]
