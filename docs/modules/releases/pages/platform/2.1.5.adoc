...
|AdminWebModule
|3.1.1.RELEASE
|xref:3.2.0@admin-web-module::releases/3.x.adoc#3-2-0[{asm-admin-web-module-version}]

|BootstrapUiModule
|2.2.1.RELEASE
|xref:2.2.2@bootstrap-ui-module::releases/2.x.adoc#2-2-2[{asm-bootstrap-ui-module-version}]

|EntityModule
|3.3.0.RELEASE
|xref:3.4.0@entity-module::releases/3.x.adoc#3-4-0[{asm-entity-module-version}]
