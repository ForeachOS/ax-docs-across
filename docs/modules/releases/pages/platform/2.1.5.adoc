...
|AdminWebModule
|3.1.1.RELEASE
|xref:3.2.0-SNAPSHOT@admin-web-module::releases/3.x.adoc#3-2-0[3.2.0-SNAPSHOT]

|BootstrapUiModule
|2.2.1.RELEASE
|xref:2.2.2-SNAPSHOT@bootstrap-ui-module::releases/2.x.adoc#2-2-2[2.2.2-SNAPSHOT]

|EntityModule
|3.3.0.RELEASE
|xref:3.4.0-SNAPSHOT@entity-module::releases/3.x.adoc#3-4-0[3.4.0-SNAPSHOT]
