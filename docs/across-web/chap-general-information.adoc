 ...
 * AcrossWebModule provides infrastructure for <<layout-templates,templates>>, <<building-menus,menu building>> and <<web-resource-registry,registering web resources>>
