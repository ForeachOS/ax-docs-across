...
{{book.spring_url}}[Spring framework] is a de facto industry standard for building Java (web) applications.
...
In the link:index.adoc#fundamentals-ax-standard-modules[standard modules] for example, there are modules building on top of {{book.spring_data_url}}[Spring Data], {{book.spring_batch_url}}[Spring Batch] and {{book.spring_security_url}}[Spring security].
